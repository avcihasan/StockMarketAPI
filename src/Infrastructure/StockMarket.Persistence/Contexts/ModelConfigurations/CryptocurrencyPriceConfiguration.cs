...
{
    public class CryptocurrencyPriceConfiguration : IEntityTypeConfiguration<CryptocurrencyPrice>
    {
        public void Configure(EntityTypeBuilder<CryptocurrencyPrice> builder)
        {
